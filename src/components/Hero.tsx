...
const Hero = () => {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-blue-900/20 to-cyan-900/20 pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-4rem)]">
          ...
          >
            ...
            >
              <motion.button
                ...
                className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold rounded-full transition-all duration-300 hover:from-cyan-400 hover:to-blue-500 shadow-lg"
              >
                Let's Work Together
              </motion.button>
          ...
          >
            <motion.div
              ...
              className="relative w-64 h-64 rounded-full bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 p-1 shadow-2xl"
            >
